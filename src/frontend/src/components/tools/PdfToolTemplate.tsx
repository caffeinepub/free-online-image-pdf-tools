...
import { type ToolData, getRelatedTools } from "@/utils/toolsData";
...
export function PdfToolTemplate({ tool, children }: PdfToolTemplateProps) {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <Breadcrumb
          items={[{ label: "Tools", href: "/" }, { label: tool.name }]}
        />
