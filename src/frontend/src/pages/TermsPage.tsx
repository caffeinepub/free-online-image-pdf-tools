      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="prose-dark space-y-6">
          <p>
            ...
            ToolsHub Free. By accessing or using our website, you agree to be
            bound by these terms.
          </p>

          <h2>1. Acceptance of Terms</h2>
          <p>
            By using ToolsHub Free, you confirm that you are at least 13 years
            of age and agree to these Terms and Conditions. If you do not agree,
            please do not use our services.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            ToolsHub Free provides free online tools for image and PDF
            processing. All processing occurs locally in your browser. We
          ...
          <p>
            The ToolsHub Free website, including its design, code, and content,
          ...
          <p>
            You retain all rights to the files you process using our tools. We
          ...
          <p>
            ...
            agree to the display of advertisements. We use Google AdSense for
            advertising, which may use cookies to serve relevant ads.
          </p>

          <h2>7. Disclaimer of Warranties</h2>
          <p>
            Our tools are provided "as is" without warranties of any kind. We do
            not guarantee that our tools will be error-free, uninterrupted, or
            produce specific results.
          </p>

          <h2>8. Limitation of Liability</h2>
          <p>
            To the fullest extent permitted by law, ToolsHub Free shall not be
            liable for any damages arising from your use of our tools, including
            but not limited to data loss, file corruption, or business
            interruption.
          </p>
