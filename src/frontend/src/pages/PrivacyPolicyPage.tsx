    ...
    <>
      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="prose-dark space-y-6">
          <p>
            At ToolsHub Free, we are committed to protecting your privacy. This
          ...
          <p>
            <strong>Files and Documents:</strong> All file processing (images,
            PDFs) happens entirely in your browser using client-side JavaScript.
            Your files are never uploaded to our servers and we have no access
            to them.
          </p>
          <p>
            <strong>Usage Data:</strong> We may collect anonymous usage
            statistics such as which tools are used most frequently, page views,
            and general traffic patterns. This data does not include any
            personally identifiable information.
          </p>
          <p>
            <strong>Contact Form:</strong> When you submit our contact form, we
            collect your name, email address, and message to respond to your
            inquiry.
          </p>
          ...
          <ul>
            <li>
              ...
              Google's use of advertising cookies enables it to serve ads based
              on your visits to our site and other sites on the Internet.
            </li>
            <li>
          ...
          <p>
            Since all file processing occurs locally in your browser, your
            documents and images are never transmitted to our servers. We
            implement appropriate security measures to protect any data we do
            collect.
          </p>
