          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              },
              {
                ...
                action: () => doRotate(0, true, false),
              },
              {
                label: "Flip V",
                icon: <FlipVertical size={16} />,
                action: () => doRotate(0, false, true),
              },
            ].map((btn) => (
              <button
                type="button"
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-border text-sm text-foreground hover:border-primary/50 hover:bg-primary/5 transition-all disabled:opacity-50"
              >
                {isProcessing ? (
