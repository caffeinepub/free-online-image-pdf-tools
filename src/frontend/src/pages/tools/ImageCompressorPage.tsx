...
export function ImageCompressorPage() {
  ...
  const { compress, isProcessing, result, error, reset } =
    useImageCompression();
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-lg text-sm border border-border text-muted-foreground hover:text-foreground hover:border-primary/50 transition-all flex items-center gap-2"
            >
