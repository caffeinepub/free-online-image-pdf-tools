...
export const seedBlogPosts: SeedBlogPost[] = [
  {
    ...
    excerpt:
      "Learn how to compress images for faster website loading without sacrificing quality. Discover the best image compression techniques and tools.",
    content: `
...
Image compression is essential for fast-loading websites. With the right tools and techniques, you can significantly reduce image file sizes while maintaining excellent visual quality.
    ...
    metaDescription:
      "Learn how to compress images for faster websites. Best practices for JPEG, PNG, and WebP compression. Free online image compression tools.",
    keywords:
      "compress images for web, image compression guide, reduce image size, webp compression",
  },
  {
    id: "2",
    ...
    excerpt:
      "Discover the best free online PDF tools for merging, splitting, converting, and editing PDF files. No software installation required.",
    content: `
...
These free online PDF tools cover all your document management needs without requiring any software installation. All processing happens in your browser for maximum privacy and security.
    ...
    metaDescription:
      "Discover the best free online PDF tools. Merge, split, compress, convert PDFs online. No software needed. Fast and secure.",
    keywords:
      "free pdf tools online, best pdf tools, merge pdf free, split pdf online, pdf converter",
  },
  {
    id: "3",
    ...
    excerpt:
      "Confused about image formats? Learn the differences between JPG, PNG, and WebP to choose the right format for every situation.",
    content: `
...
For modern websites, WebP is the best choice when browser support allows. Use JPEG for photographs where transparency isn't needed, and PNG for graphics, logos, and images requiring transparency.
    ...
    metaDescription:
      "Learn the differences between JPG, PNG, and WebP image formats. When to use each format for best quality and performance.",
    keywords:
      "jpg vs png vs webp, image formats comparison, best image format web, jpeg png webp differences",
  },
];
