...
export class Backend implements backendInterface {
    ...
    async addBlogPost(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<string>): Promise<void> {
    ...
    async getBlogPostsSortedByDate(): Promise<Array<BlogPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBlogPostsSortedByDate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyAnalytics(arg0: string): Promise<DailyAnalytics> {
        if (this.processError) {
            try {
    ...
    async updateAnalytics(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAnalytics(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
