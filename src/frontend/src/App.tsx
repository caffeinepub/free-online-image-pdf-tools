...
const ImageCompressorPage = lazy(() =>
  import("./pages/tools/ImageCompressorPage").then((m) => ({
    default: m.ImageCompressorPage,
  })),
);
const ImageResizerPage = lazy(() =>
  import("./pages/tools/ImageResizerPage").then((m) => ({
    default: m.ImageResizerPage,
  })),
);
const JpgToPngPage = lazy(() =>
  import("./pages/tools/JpgToPngPage").then((m) => ({
    default: m.JpgToPngPage,
  })),
);
const PngToJpgPage = lazy(() =>
  import("./pages/tools/PngToJpgPage").then((m) => ({
    default: m.PngToJpgPage,
  })),
);
const ImageCropperPage = lazy(() =>
  import("./pages/tools/ImageCropperPage").then((m) => ({
    default: m.ImageCropperPage,
  })),
);
const ImageRotatorPage = lazy(() =>
  import("./pages/tools/ImageRotatorPage").then((m) => ({
    default: m.ImageRotatorPage,
  })),
);
const ImageToWebpPage = lazy(() =>
  import("./pages/tools/ImageToWebpPage").then((m) => ({
    default: m.ImageToWebpPage,
  })),
);
const WebpToJpgPage = lazy(() =>
  import("./pages/tools/WebpToJpgPage").then((m) => ({
    default: m.WebpToJpgPage,
  })),
);
const BackgroundRemoverPage = lazy(() =>
  import("./pages/tools/BackgroundRemoverPage").then((m) => ({
    default: m.BackgroundRemoverPage,
  })),
);
const ImageMetadataViewerPage = lazy(() =>
  import("./pages/tools/ImageMetadataViewerPage").then((m) => ({
    default: m.ImageMetadataViewerPage,
  })),
);
const PdfToWordPage = lazy(() =>
  import("./pages/tools/PdfToWordPage").then((m) => ({
    default: m.PdfToWordPage,
  })),
);
const WordToPdfPage = lazy(() =>
  import("./pages/tools/WordToPdfPage").then((m) => ({
    default: m.WordToPdfPage,
  })),
);
const PdfMergePage = lazy(() =>
  import("./pages/tools/PdfMergePage").then((m) => ({
    default: m.PdfMergePage,
  })),
);
const PdfSplitPage = lazy(() =>
  import("./pages/tools/PdfSplitPage").then((m) => ({
    default: m.PdfSplitPage,
  })),
);
const PdfCompressorPage = lazy(() =>
  import("./pages/tools/PdfCompressorPage").then((m) => ({
    default: m.PdfCompressorPage,
  })),
);
const PdfLockPage = lazy(() =>
  import("./pages/tools/PdfLockPage").then((m) => ({ default: m.PdfLockPage })),
);
const PdfUnlockPage = lazy(() =>
  import("./pages/tools/PdfUnlockPage").then((m) => ({
    default: m.PdfUnlockPage,
  })),
);
const PdfWatermarkPage = lazy(() =>
  import("./pages/tools/PdfWatermarkPage").then((m) => ({
    default: m.PdfWatermarkPage,
  })),
);
const PdfPageNumbersPage = lazy(() =>
  import("./pages/tools/PdfPageNumbersPage").then((m) => ({
    default: m.PdfPageNumbersPage,
  })),
);
const PdfToJpgPage = lazy(() =>
  import("./pages/tools/PdfToJpgPage").then((m) => ({
    default: m.PdfToJpgPage,
  })),
);
const JpgToPdfPage = lazy(() =>
  import("./pages/tools/JpgToPdfPage").then((m) => ({
    default: m.JpgToPdfPage,
  })),
);
...
function AdSenseGuard() {
  ...
  useEffect(() => {
    ...
    if (isAdminRoute) {
      ...
      const arr = win.adsbygoogle as
        | { push?: unknown; _disabled?: boolean }
        | undefined;
      if (arr?._disabled) {
        arr.push = undefined;
        arr._disabled = undefined;
      }
    }
  }, [pathname]);
...
const webpToJpgRoute = createRoute({
  getParentRoute: () => rootRoute,
...
const imageMetadataRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/tools/image-metadata-viewer",
  component: () => <ImageMetadataViewerPage />,
});
...
const pdfLockRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/tools/pdf-lock",
  component: () => <PdfLockPage />,
});
const pdfUnlockRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/tools/pdf-unlock",
  component: () => <PdfUnlockPage />,
});
const pdfWatermarkRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/tools/pdf-watermark",
  component: () => <PdfWatermarkPage />,
});
const pdfPageNumbersRoute = createRoute({
  getParentRoute: () => rootRoute,
